...
I have built s Sudden Ionospheric Disturbance receiver that can see the affects of solar activity on the D-layer of the ionossphere.
I have enjoyed correlating the VLF signal changes that I observe with movies of solar activity that NASA used to make availabel on thier website: https://sdo.gsfc.nasa.gov/
